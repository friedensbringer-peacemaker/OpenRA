# Nativer OpenXR-Starttest für Quest

Dieser getrennte Android-ARM64-Baustein prüft den offiziellen Khronos-OpenXR-Loader, die benötigten Android-/OpenGL-ES-Erweiterungen und das Headset-System. Er erzeugt noch keine XR-Session, Swapchain oder OpenRA-Spieloberfläche. Die bestehende `OpenRA.Quest.Probe` bleibt bis zur Geräteprüfung unverändert.
...
Standardausgabe: `../Artifacts/OpenRA-XR-Loader-Probe-untested.apk`. Die APK enthält die Java-Activity, beide ARM64-Bibliotheken, OpenXR-Manifestrechte und die immersive Intent-Kategorie. Der Build prüft ihre Signatur. Die Android-Runtime wurde damit noch nicht gestartet; der Quest-Test bleibt ausstehend. Die bestehende OpenRA-2D-App wird von dieser Diagnose-APK weder ersetzt noch verändert.
