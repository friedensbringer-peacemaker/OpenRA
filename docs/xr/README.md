...
Der nächste große Meilenstein ist ein auf Quest 3 bestätigter Spielablauf auf einer räumlichen Fläche. OpenRAs vollständiger `WorldRenderer` hat die Blitz-Karte auf Quest 3 gezeichnet. Die neue lokale Spielsession mit KI-Client wurde auf Quest initialisiert; fortlaufende Ticks sind wegen des eingeschlafenen Headsets noch nicht belegt. Die experimentelle OpenXR-Quad-Brücke ist gebaut, aber auf dem Gerät noch nicht gestartet.
