...
- **Status:** Die signierte Android-ARM64-Probe läuft auf Quest 3. Sie lädt 307 Red-Alert-Akteure, 89 Waffen und die Karte „Blitz“ (98×98). Originale Tiles und Panzer-Sprites sowie die vollständige Editor-Welt mit Terrain und Map-Actors wurden auf dem Gerät gezeichnet. Eine reguläre Welt mit lokalem Spieler erreichte ihren ersten Simulationstick. Eine fortlaufende lokale Session, Touch-Auswahl/Kontextklicks, ein In-App-Import für das separate Red-Alert-ZIP und eine kombinierte OpenXR-Quad-/Controllerbrücke sind implementiert und als APK gebaut; ihr gemeinsamer Quest-Test und Leistungsmessungen stehen noch aus. Ein KI-Gegner fehlt in der aktuellen Session noch.
