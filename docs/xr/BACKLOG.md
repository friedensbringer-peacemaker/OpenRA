...
- **Status:** Die signierte Android-ARM64-Probe läuft auf Quest 3. Sie lädt 307 Red-Alert-Akteure, 89 Waffen und die Karte „Blitz“ (98×98). Originale Tiles und Panzer-Sprites sowie die vollständige Editor-Welt mit Terrain und Map-Actors wurden auf dem Gerät gezeichnet. Die aktualisierte kombinierte APK wurde auf Quest installiert und initialisierte die lokale Session mit aktiviertem `normal`-KI-Gegner; fortlaufende Ticks und ein vollständiges Gefecht sind wegen des eingeschlafenen Headsets noch nicht bestätigt. Touch-Auswahl/Kontextklicks, ein In-App-Import für das separate Red-Alert-ZIP und die OpenXR-Quad-/Controllerbrücke sind implementiert; ihr gemeinsamer Quest-Test und Leistungsmessungen stehen noch aus. [Teilbefund](QUEST-TEST-2026-09-26.md).
