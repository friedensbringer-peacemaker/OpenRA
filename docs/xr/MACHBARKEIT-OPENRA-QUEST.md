...
| --- | --- |
| .NET und Mod-Laden | OpenRA nutzt Reflection, dynamische Assembly-Ladevorgänge und Desktop-Dateipfade. Die Probe lädt Mod-Assemblies, Regeln, Traits und eine Karte auf Quest 3, startet Editor- und reguläre Spielwelten und zeichnet den Editor-Weltframe. Fortlaufendes Spiel, Inhaltsimport für Endnutzer und weitere Karten sind noch offen. |
